...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    >
      <div className="border-4 w-2 h-2 rounded-full ring-primary-foreground" />
    </CheckboxPrimitive.Indicator>
  </CheckboxPrimitive.Root>
));
CustomRadio.displayName = CheckboxPrimitive.Root.displayName;
